...
_TRANSFORMATIONPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='debug_display', full_name='caffe.TransformationParameter.debug_display', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='contrast_adjustment', full_name='caffe.TransformationParameter.contrast_adjustment', index=6,
      number=7, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='smooth_filtering', full_name='caffe.TransformationParameter.smooth_filtering', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='jpeg_compression', full_name='caffe.TransformationParameter.jpeg_compression', index=8,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='min_scaling_factor', full_name='caffe.TransformationParameter.min_scaling_factor', index=9,
      number=10, type=2, cpp_type=6, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='max_scaling_factor', full_name='caffe.TransformationParameter.max_scaling_factor', index=10,
      number=11, type=2, cpp_type=6, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='angle_interval', full_name='caffe.TransformationParameter.angle_interval', index=11,
      number=12, type=2, cpp_type=6, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='max_shearing_ratio', full_name='caffe.TransformationParameter.max_shearing_ratio', index=12,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='max_perspective_ratio', full_name='caffe.TransformationParameter.max_perspective_ratio', index=13,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='warp_fillval', full_name='caffe.TransformationParameter.warp_fillval', index=14,
